...
for fname in fnames_list:
    ...
    print("| {} | {} | {} | <audio controls=\"controls\" > <source src=\"wav/SYNTH-FACE/{}.wav\" autoplay/> Your browser does not support the audio element. </audio> | <audio controls=\"controls\" > <source src=\"wav/SYNTH-SPEECH/{}.wav\" autoplay/> Your browser does not support the audio element. </audio> |".format(vggid, spkname, gender, voxcelebid, voxcelebid))
